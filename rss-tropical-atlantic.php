...
// rss-tropical-atlantic.php  version 1.00 - 03-May-2006
...
function startElementATL($parser, $name, $attrs) {
...
function endElementATL($parser, $name) {
...
function characterDataATL($parser, $data) {
	global $insideitem, $tag, $title, $description, $link, $lastBuildDate,$doSummary,$Summary, $PageTitle;
...
xml_set_element_handler($xml_parser, "startElementATL", "endElementATL");
xml_set_character_data_handler($xml_parser, "characterDataATL");
...
$STRopts = array(
	  ...
	  'header'=>"Cache-Control: no-cache, must-revalidate\r\n" .
				...
				"Connection: close\r\n" .
				"User-agent: Mozilla/5.0 (rss-tropical-atlantic - saratoga-weather.org)\r\n" .
				"Accept: text/plain\r\n"
	  ),
	  'ssl'=>array(
	  'method'=>"GET",
